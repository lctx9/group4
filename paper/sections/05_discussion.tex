...
Our empirical evaluation demonstrates that interactive terminal execution feedback increases the Fail-to-Pass (F2P) rate from 16.60\% (static baseline) to 35.05\% at Pass@1 and 71.59\% at Pass@3. This substantial performance leap stems from two primary observable mechanics:
...
Figure~\ref{fig:turns} illustrates the distribution of interaction turns consumed per task, highlighting the 10.21\% ceiling of turn exhaustion.
