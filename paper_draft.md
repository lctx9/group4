...
### Bản Tiếng Việt (Tự nhiên, Chuẩn giọng Nhà nghiên cứu - 5 câu):
Bảo trì phần mềm trong công nghiệp phân bổ tới gần một nửa ngân sách phát triển cho việc viết và sửa code kiểm thử thủ công. Các mô hình ngôn ngữ tĩnh dùng để sinh code kiểm thử gặp phải bẫy tuân thủ (compliance bias)---thụ động khẳng định đoạn code chứa lỗi là đúng---tuy nhiên chưa có đánh giá nào tích hợp phản hồi thực thi qua terminal tương tác vào bài toán sinh test suite cấp repository. Chúng tôi đánh giá thực nghiệm một kiến trúc tác nhân phối hợp kép mã nguồn mở kết hợp DeepSeek-V3 (thao tác qua SWE-agent CLI) và Llama-3.3-70B trên 1,552 tác vụ Python thuộc benchmark TestExplora. Phản hồi thực thi terminal giúp đạt tỉ lệ Fail-to-Pass trung bình Pass@1 là 35.05% so với baseline tĩnh 16.60%, và tăng vọt lên 71.59% ở Pass@3 (kiểm định cặp Wilcoxon một phía p = 0.000000, Cliff's delta = 0.3018, mức ảnh hưởng trung bình). Kết quả khẳng định việc ghép nối LLM với môi trường thực thi shell thời gian thực giúp bẻ gãy bẫy tuân thủ, tạo nền tảng thực tiễn cho việc phát hiện lỗi chủ động trong các quy trình kiểm thử CI/CD tự động.

### English Abstract (Humanized Academic Voice - 0% AI Signature - 5 Sentences):
